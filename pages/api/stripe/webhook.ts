...
async function handleSubscriptionUpdate(subscription: Stripe.Subscription) {
  ...
  // Safely extract current_period_end using helper
  const currentPeriodEndTimestamp = getSubscriptionCurrentPeriodEnd(subscription);
...
async function handleInvoicePaymentSucceeded(invoice: Stripe.Invoice) {
  // Safely extract subscription ID using helper
